            ...
            <section className="py-14">
                <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                    <div className="max-w-xl mx-auto sm:text-center">
                        <h3 className="text-white-800 text-3xl font-semibold sm:text-4xl">
                            Our team
                        </h3>
                        ...
                        <ul className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
                            {
                                team.map((item, idx) => (
                                    <li key={idx}>
                                        ...
                                        <div className="mt-4">
                                            <h4 className="text-lg text-orange-700 font-semibold ">{item.name}</h4>
                                            <p className="text-white opacity-50">{item.title}</p>
                                        </div>
                                    </li>
                                ))
                            }
