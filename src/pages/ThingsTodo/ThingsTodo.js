    ...
    return (
        <div className='p-4'>
            ...
            <Link to={`/countryDetails`} onClick={() => setcountryId(1)}>
                <div className='flex items-center  w-[450px] w-[95%] mb-2'>
                    <img src="https://static.saltinourhair.com/wp-content/uploads/2020/01/23123153/malaysia-2-week-travel-guide-600x600.jpg" className='lg:w-[150px] lg:h-[100px] w-[1580px0px] h-[80px]' alt="" />
