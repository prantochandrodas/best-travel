...
const Package = ({data}) => {
    ...
    return (
        <div>
            <article className="max-w-md mx-auto mt-4 shadow-lg border rounded-md duration-300 hover:shadow-sm md:h-[400px] md:w-[230px] w-[90%]">
                <img src={data.picture} loading="lazy" alt="img" className="w-full lg:w-[500px] lg:h-30 h-48 rounded-t-md" />
                <div className="pt-3 ml-4 mr-2 mb-3">
                    <h3 className="text-md font-semibold opacity-50 ">
                        {data.name}
                    </h3>
